...
require('packer').startup(function()
 ...
 -- UI to select things (files, grep results, open buffers...)
  ...
  use 'katawful/kat.nvim' --kat theme
  use 'folke/tokyonight.nvim' --tokyonight colorscheme
  use {'ms-jpq/chadtree', branch = 'chad', run = 'python3 -m chadtree deps'}
  use 'glepnir/lspsaga.nvim' --lsp helpers
...
--Set chadtree theme
-- local chadtree_settings = { ['chadtree_settings.theme'] = 'tokyonight' }
...
map('n', ',,', [[<cmd>lua require('telescope.builtin').buffers({layout_strategy='vertical', layout_config={width=0.9}})<CR>]], { noremap = true, silent = true })
...
map('n', '<leader>ff', [[<cmd>lua require('telescope.builtin').find_files(require('telescope.themes').get_dropdown({}))<CR>]], { noremap = true, silent = true })
...
-- do not show diagnostics inline by default
...
local servers = { 'rust_analyzer', 'pyright', 'cssls', 'pyright', 'solargraph' }
